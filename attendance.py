...
engine = pyttsx3.init()
engine.say(" Welcome to attendance portal ")
...
window = Tk()
window.iconbitmap('UI_Image/student.ico')
window.title("pranveer singh institute of technology")
...
vi = Image.open("UI_Image/psit1.webp")
